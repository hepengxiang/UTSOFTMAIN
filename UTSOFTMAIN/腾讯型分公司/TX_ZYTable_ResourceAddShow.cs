...
{
    public partial class TX_ZYTable_ResourceAddShow : Form
    {
        public TX_ZYTable_ResourceAddShow()
        {
            InitializeComponent();
        }
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                sql1 = string.Format("insert into TX_ZYTable_ResourceAdd (QQType,AddType,GroupName,EnterTime,AddAllCount," +
            ...
            if (resultNum1 > 0)
            {
                ...
                " b.AssumedName from TX_ZYTable_ResourceAdd a left join Users b on a.SubmitPerson = b.StaffID" +
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("你确定要删除【" + this.dateTimeInput1.Value.ToShortDateString() + "】的数据吗?", "删除提醒", MessageBoxButtons.YesNo) == DialogResult.No)
                return;
            string sql1 = string.Format("delete from TX_ZYTable_ResourceAdd where id = {0}",
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                sql1 = string.Format("update TX_ZYTable_ResourceAdd set "+
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            string sql1 = string.Format("select a.id,a.QQType,a.AddType,a.GroupName,a.EnterTime,datename(weekday, a.EnterTime) as 星期," + 
                ...
                " b.CompanyNames = '智源' and "+
                " a.SubmitPerson like '%{4}%' and a.EnterTime between '{5}' and '{6}'",
                qqType, groupName, this.comboBoxEx5.Text, "", this.comboBoxEx2.SelectedValue,
        ...
        private void comboBoxEx2_DropDown(object sender, EventArgs e)
        {
            ...
            string[] columNames = new string[] { "StaffID", "AssumedName" };
