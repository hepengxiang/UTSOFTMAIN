...
{
    public partial class TX_ZYTable_ResourceDevelopShow : Form
    {
        public TX_ZYTable_ResourceDevelopShow()
        {
            InitializeComponent();
        }
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                sql1 = string.Format("insert into TX_ZYTable_ResourceDevelop (QQType,AddType,GroupName,EnterTime,DevelopCount,FistLanguage,"+
            ...
            if (resultNum1 > 0)
            {
                ...
                " b.AssumedName from TX_ZYTable_ResourceDevelop a left join Users b on a.SubmitPerson = b.StaffID" +
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("你确定要删除【" + this.dateTimeInput1.Value.ToShortDateString() + "】的数据吗?", "删除提醒", MessageBoxButtons.YesNo) == DialogResult.No)
                return;
            string sql1 = string.Format("delete from TX_ZYTable_ResourceDevelop where id = {0}",
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                sql1 = string.Format("update TX_ZYTable_ResourceDevelop set "+
