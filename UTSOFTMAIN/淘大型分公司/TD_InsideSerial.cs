...
{
    public partial class TD_InsideSerial : Form
    {
        public TD_InsideSerial()
        {
            InitializeComponent();
        }
        ...
        private void TD_InsideSerial_Load(object sender, EventArgs e)
        {
            ...
            windowText = (sender as TD_InsideSerial).Text;
        }
        ...
        private void dataGridViewX1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            this.textBoxX3.Text = this.dataGridViewX1.SelectedRows[0].Cells[13].Value.ToString();
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            if (resultNum1 > 0)
            {
                ...
                this.dataGridViewX1.SelectedRows[0].Cells[13].Value = this.textBoxX3.Text;
        ...
        {
            string sql1 = string.Format("select * from Pub_SerialDetail where CompanyNames = '{0}' " +
                " and EnterType like '%{1}%' and TableType = '备用金周转记录' and SerialNum like '%{2}%' and EnterTime between '{3}' and '{4}' and Remark like '%{5}%'" +
                "",
                this.comboBoxEx4.Text.Trim(), 
            ...
            if (this.textBoxX9.Text != "")
            {
                sql1 += string.Format(" and Value = {0} ", this.textBoxX9.Text.Trim());
            }
