...
{
    public partial class UT_KF_TSTKJXManager : Form
    {
        public int forID;
        ...
        public string jxperson = "";
        public string companyType = "";
        public UT_KF_TSTKJXManager()
        {
            InitializeComponent();
        }

        private void UT_KF_TSTKJXManager_Load(object sender, EventArgs e)
        {
            ...
            //if (enterType == "投诉") 
            //{
            //    this.comboBoxEx3.Text = "投诉";
            //    this.comboBoxEx4.Text = "1";
            //    this.comboBoxEx3.Enabled = false;
            //    this.comboBoxEx4.Enabled = false;
            //}
            //if (companyType == "腾讯" && enterType == "退款")
            //{
            //    this.comboBoxEx3.Text = "退款";
            //    this.comboBoxEx3.Enabled = false;
            //}
            this.textBoxX2.Text = jxperson;
        }
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                resultNum1 = PublicMethod.insert_TSTKJX(
                    forID,
            ...
            if (resultNum1)
            {
                ...
                string sqlFlush = string.Format("select a.id,c.QQ,c.NickName,b.DepartmentName,b.AssumedName,a.StaffID,a.EnterTypeSmall,a.Value,a.Remark" +
                    ...
                    " where a.StaffID = a.AmountManager and a.EnterTypeSmall != '绩效退款' and a.ForID = {0}", forID);
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                resultNum1 = PublicMethod.delete_TSTKJX(
